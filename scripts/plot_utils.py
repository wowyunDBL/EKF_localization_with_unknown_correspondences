...
def plot_traj(urs_states, belief_states, markers, markers_in_map, index, np_z_hat, np_z_true, bel_pose, real_pose, cols, icp_flag):
    ...
    '''plot traj'''
    plt.scatter(x_urs[0], y_urs[0], color='b', label="URS state", s=10)
